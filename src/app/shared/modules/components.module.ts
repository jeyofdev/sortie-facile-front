...
import { ActivityPreviewTableCardComponent } from '@shared/components/card/activity-preview-table-card/activity-preview-table-card.component';
...
@NgModule({
	declarations: [
		...
		ActivityPreviewTableCardComponent,
	],
